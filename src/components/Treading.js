...
import Treading1 from './Svg/Treading1.svg'

const Treading = () => {
  return (
    <div>
        <img class="my-10" src= {Treading1}/>
        <div  class = "-my-20 "id="blog" >
        <div class="max-w-5xl mx-auto px-6 md:px-12 xl:px-6"> 
        <slot />
      ...
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="group p-6 sm:p-7 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-xl shadow-gray-600/10">
          <div class="relative overflow-hidden rounded-xl">
